...
app.controller('outBoundController', ['$scope', '$filter', function ($scope, $filter) {
    ...
    $scope.activeCalls = 0;
    $scope.teams = {
        fresh_a: [2181, 2168, 2023, 2122, 2393, 2369, 2132, 2611, 2197, 2164, 2461, 2293, 2351],
        fresh_b: [2363, 2467, 2151, 2606, 2289, 2080, 2262, 2004, 2273, 2292, 2182, 2255],
        fresh_c: [2105, 2294, 2060, 2304, 2053, 2141, 2375, 2124, 2194, 2154, 2366, 2155, 2063],
        fresh_d: [2313, 2388, 2298, 2373, 2287, 2119, 2295, 2120, 2462, 2601, 2058],
        data_bank_a: [2171, 2287, 2462, 2394, 2269, 2148, 2368],
        data_bank_b: [2353, 2285]
    };
