...
app.controller('outBoundController', ['$scope', '$filter', function ($scope, $filter) {
    ...
    $scope.activeCalls = 0;
    $scope.teams = {
        fresh_a: [2168,2023,2122,2393,2369,2132,2611,2164,2461,2293,2351,2467],
        fresh_b: [2151,2606,2080,2262,2004,2273,2292,2182,2255,2060,2304,2053],
        data_bank_a: [2141,2375,2124,2194,2154,2366,2063,2373,2120,2298,2058,2601],
        data_bank_b: [2295,2294,2289,2119,2197,2388,2462,2287,2155,2181,2365,2105,2353,2285,2190],
        data_bank_c: [2028,2005,2022,2002,2071,2101,2123,2469,2139,2037,2313,2388,2462,2287]
    };
